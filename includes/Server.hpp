...
/*   Updated: 2024/11/21 17:37:43 by fanny            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Server {
 ...
 private:
  ...
  bool isModeArgumentCorrect(const stringVector &argumentToCheck);
  bool isModeStringCorrect(const stringVector &argumentToCheck);
